...
function cell.openCellDoor ()
    ...
    chain:move("guard 1", 53, 44)
    chain:move("guard 1", 48, 53)
    chain:turn("guard 1", "east")
    chain:move("guard 2", 53, 44)
    chain:move("guard 2", 62, 38)
...
function cell.throwDust ()
    ...
    chain:move("guard 2", 56, 45)
    chain:move("ego", 70, 45)
    chain:turn("guard 2", "east")
    chain:turn("ego", "west")
